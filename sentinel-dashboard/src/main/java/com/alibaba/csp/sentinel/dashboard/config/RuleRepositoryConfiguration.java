...
/**
 * {@link RuleRepository}'s implementation bean configuration.
 *
 * @author wxq
 */
@Configuration
public class RuleRepositoryConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public InMemApiDefinitionStore inMemApiDefinitionStore() {
        return new InMemApiDefinitionStore();
    }

    @Bean
    @ConditionalOnMissingBean
    public InMemGatewayFlowRuleStore inMemGatewayFlowRuleStore() {
